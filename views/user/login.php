...
<head>
    ...
    <style>
        ...
        include "themes/dark/bg/squares_style.css"
        ?>

    </style>
    <title>Senongram | Login</title>
</head>
<body>
...
<div class="login">
    <div class="card">
        <div class="h1">
            <h1>Welcome to <span class="gradient-text">Senongram</span></h1>
        </div>
        <main>
...
<!---->
<!--                    </button>-->
                    <a href="/user/register" class="link">Don't have an account?</a>
                </section>
            </form>
...
<script>
    ...
    document.querySelectorAll('input').forEach(function (inp) {
        ...
        inp.oninput = function () {
            if (errors.username === 'Username or password incorrect')
                errors.username = '';
            if (inp.value) {
                if (username_inp === inp)
                    errors.username = '';
